            ...
            <div className={`mobile-menu ${mobileMenuOpen ? 'active' : ''}`}>
              ...
              <div className="mobile-menu-footer">
                <div className="mobile-social-links">
                  <a href="https://www.facebook.com/share/1Ga8spfH7y/?mibextid=wwXIfr" className="mobile-social-link" target="_blank" rel="noopener noreferrer">
              ...
              <div className="partners-track">
                <div className="single-partner-card">
                  <div className="logo-item">
                    <Image src="/partners/alu-logo.png" alt="ALU" width={110} height={50} />
                  </div>
                  <div className="logo-item">
                    <Image src="/partners/rwandair-logo.png" alt="RwandAir" width={110} height={50} />
                  </div>
                  <div className="logo-item">
                    <Image src="/partners/bk-logo.png" alt="Bank of Kigali" width={110} height={50} />
                  </div>
                  <div className="logo-item">
                    <Image src="/partners/bralirwa-logo.png" alt="Bralirwa" width={110} height={50} />
                  </div>
                  <div className="logo-item">
                    <Image src="/partners/lemigo-logo.png" alt="Lemigo Hotel" width={110} height={50} />
                  </div>
                  <div className="logo-item">
                    <Image src="/partners/radisson-logo.png" alt="Radisson Blue" width={110} height={50} />
                  </div>
                  <div className="logo-item">
                    <Image src="/partners/rra-logo.png" alt="RRA" width={110} height={50} />
                  </div>
                  <div className="logo-item">
                    <Image src="/partners/moshions-logo.png" alt="Moshions" width={110} height={50} />
                  </div>
                </div>
          ...
          <div className="footer-content">
            ...
            <div className="footer-column">
              ...
              <div className="footer-contact">
                ...
                <a href="mailto:amoriaglobaltech@gmail.com" className="contact-item">
